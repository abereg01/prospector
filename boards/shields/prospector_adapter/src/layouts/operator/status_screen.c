...
lv_obj_t *zmk_display_status_screen() {
    ...
    //     │  "KLOR" wordmark   [reserved]  │  pos (10, 175)
    // 280 └────────────────────────────────┘

    lv_obj_t *screen = lv_obj_create(NULL);
    lv_obj_set_style_bg_color(screen, lv_color_hex(0x2E3440), LV_PART_MAIN);  // Nord0
    ...
    lv_obj_set_style_text_color(klor_label, lv_color_hex(DISPLAY_COLOR_MOD_ACTIVE), LV_PART_MAIN);  // Nord8 frost blue
    lv_obj_set_pos(klor_label, 10, 175);
